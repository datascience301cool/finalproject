...
After undoing the log transformation, the predicted `price` ended up being $28,966, which was also pretty close to the actual `price`. We were  satisfied with these results; however, after seeing that the model over-predicted the `price` in the first test and then under-predicted it in the second test, we knew that the there was room for improvement for this model.
