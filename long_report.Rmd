...
Before beginning the EDA, I simplified the data set by removing irrelevant columns These columns include things like the URL to the listing, the listing ID, the url to the listing's image, etc. These columns will have no predictive power.
